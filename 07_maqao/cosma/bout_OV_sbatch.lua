...
binary         = "/cosma5/data/do008/dc-park1/bout/blob2d"

-- List of external libraries to analyze
external_libraries = {
-- "lib.so", "lib.so"
--"~/BOUT-dev-may/lib/libbout++.a"
"/cosma/home/do008/dc-park1/BOUT-dev-may/lib/libbout++.a"
}
...
run_command    = "<binary> -d /cosma5/data/do008/dc-park1/bout/delta_0.25"
...
batch_script    = "bout_maqao.sbatch"
...
mpi_command    = "mpiexec -genv UCX_NET_DEVICES mlx5_1:1 -n <number_processes>"
